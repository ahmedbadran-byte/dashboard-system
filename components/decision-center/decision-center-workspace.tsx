...
import { decisionItems, departments } from '@/lib/mock-data';
    ...
    <section className="space-y-6 p-4 md:p-6">
      <section className="card p-5">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          {decisionItems.alerts.map((alert) => (
      ...
      <section className="card p-5">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          {decisionItems.insights.map((insight) => (
      ...
      <section className="card p-5">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          {decisionItems.recommendations.map((recommendation) => (
